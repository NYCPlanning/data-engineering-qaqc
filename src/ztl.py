def ztl():
    ...
    def get_data():
        ...
        qc_frequencychanges['percent'] = (
            qc_frequencychanges['countnew'] / qc_frequencychanges['countold'] - 1) * 100
        qc_frequencychanges['percent'] = qc_frequencychanges['percent'].round(
            4)
        ...
        qc_versioncomparisonnownullcount['percent'] = (
            qc_versioncomparisonnownullcount['newnullcount'] / qc_versioncomparisonnownullcount['oldnullcount'] - 1) * 100
    ...
    if group == 'All':
        ...
        col = lookup[column]
        df = bbldiff.loc[bbldiff[f'{col}new'] != bbldiff[f'{col}prev'], [
    ...
    st.dataframe(
        qaqc_mismatch.loc[:, ['version', 'version_prev'] + meta[group]])
